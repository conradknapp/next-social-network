...
export const likePost = async (authUserId, postId) => {
  const { data } = await axios.put("/api/posts/like", { authUserId, postId });
  return data;
};

export const unlikePost = async (authUserId, postId) => {
  const { data } = await axios.put("/api/posts/unlike", { authUserId, postId });
  return data;
};
